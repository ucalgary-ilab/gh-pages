...
/* harmony import */ var _detail__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./detail */ "./pages/detail.js");
...
/* harmony import */ var _content_output_files_json__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../content/output/files.json */ "./content/output/files.json");
var _content_output_files_json__WEBPACK_IMPORTED_MODULE_18___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../content/output/files.json */ "./content/output/files.json", 1);
/* harmony import */ var _content_output_vimeo_json__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../content/output/vimeo.json */ "./content/output/vimeo.json");
var _content_output_vimeo_json__WEBPACK_IMPORTED_MODULE_19___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../content/output/vimeo.json */ "./content/output/vimeo.json", 1);
...
var Publications = /*#__PURE__*/function (_React$Component) {
  ...
  function Publications(props) {
    ...
    if (_this.props.short) {
      _this.publications = _this.publications.slice(0, 30);
    }
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_9__["default"])(Publications, [{
    ...
    value: function getPublications() {
      var fileNames = _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_7___default()(_content_output_summary_json__WEBPACK_IMPORTED_MODULE_16__.fileMap);
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var key = _step.value;
          this.publications.push(_content_output_summary_json__WEBPACK_IMPORTED_MODULE_16__.fileMap[key]);
        }
      } catch (err) {
        _iterator.e(err);
      } finally {
    ...
    value: function getPeople() {
      ...
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          ...
          var person = _babel_runtime_corejs2_core_js_object_assign__WEBPACK_IMPORTED_MODULE_6___default()(_content_output_summary_json__WEBPACK_IMPORTED_MODULE_16__.fileMap[key], {
            id: id
          });
    ...
    value: function getPhotos() {
      var pictures = _content_output_files_json__WEBPACK_IMPORTED_MODULE_18__.children.filter(function (dir) {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_13___default.a.createElement("div", {
        ...
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_13___default.a.createElement("div", {
          ...
          return _this2.names.includes(author) ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_13___default.a.createElement("a", {
            ...
            src: _this2.getPhoto(_this2.namesId[author]),
          ...
          return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_13___default.a.createElement("span", {
            ...
            key: keyword
          }, lodash__WEBPACK_IMPORTED_MODULE_14___default.a.startCase(keyword));
        }))))); // publications
      })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_13___default.a.createElement("div", {
        ...
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_13___default.a.createElement("div", {
        ...
        }), "".concat(publication.id)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_13___default.a.createElement("div", {
          className: "actions",
          style: {
            float: 'right',
            cursor: 'pointer',
          ...
          className: "content"
        }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_13___default.a.createElement(_detail__WEBPACK_IMPORTED_MODULE_15__["default"], {
          publication: publication,
          namesId: _this2.namesId,
          people: _this2.people,
          booktitles: _content_output_booktitles_json__WEBPACK_IMPORTED_MODULE_17__,
          files: _content_output_files_json__WEBPACK_IMPORTED_MODULE_18__,
          vimeo: _content_output_vimeo_json__WEBPACK_IMPORTED_MODULE_19__,
          short: "true"
        })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_13___default.a.createElement("div", {
          className: "actions"
        }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_13___default.a.createElement("div", {
...
//# sourceMappingURL=person.js.c70f065b6a7d33f528ed.hot-update.js.map