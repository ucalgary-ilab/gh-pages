...
var People = /*#__PURE__*/function (_React$Component) {
  ...
  function People(props) {
    ...
    if (_this.props.faculty) {
      _this.types = _this.types.slice(0, 1); // this.types.splice(4, 2)
    }

    if (_this.props.students) {
      _this.types = _this.types.slice(1, 4); // this.types.splice(4, 2)
    }
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_9__["default"])(People, [{
    ...
    value: function render() {
      ...
      }), this.props.faculty && 'People'), this.types.map(function (type) {
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_13___default.a.createElement("div", {
...
//# sourceMappingURL=index.js.260dc224acea544a85d1.hot-update.js.map