...
var Publications = /*#__PURE__*/function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_9__["default"])(Publications, [{
    ...
    key: "getPhoto",
    value: function getPhoto(person) {
      var img = "".concat(person.id, ".jpg");

      if (this.pictures.includes(img)) {
        return "/static/images/people/".concat(person.id, ".jpg");
      } else {
...
//# sourceMappingURL=person.js.daedbcbda6fc95509cfd.hot-update.js.map