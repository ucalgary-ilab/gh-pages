...
/* harmony import */ var _babel_runtime_corejs2_core_js_reflect_construct__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @babel/runtime-corejs2/core-js/reflect/construct */ "./node_modules/@babel/runtime-corejs2/core-js/reflect/construct.js");
/* harmony import */ var _babel_runtime_corejs2_core_js_reflect_construct__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_corejs2_core_js_reflect_construct__WEBPACK_IMPORTED_MODULE_4__);
...
/* harmony import */ var _content_output_files_json__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../content/output/files.json */ "./content/output/files.json");
var _content_output_files_json__WEBPACK_IMPORTED_MODULE_16___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../content/output/files.json */ "./content/output/files.json", 1);
...
function _createSuper(Derived) { var hasNativeReflectConstruct = _isNativeReflectConstruct(); return function _createSuperInternal() { var Super = Object(_babel_runtime_corejs2_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_11__["default"])(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = Object(_babel_runtime_corejs2_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_11__["default"])(this).constructor; result = _babel_runtime_corejs2_core_js_reflect_construct__WEBPACK_IMPORTED_MODULE_4___default()(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return Object(_babel_runtime_corejs2_helpers_esm_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_10__["default"])(this, result); }; }

function _isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !_babel_runtime_corejs2_core_js_reflect_construct__WEBPACK_IMPORTED_MODULE_4___default.a) return false; if (_babel_runtime_corejs2_core_js_reflect_construct__WEBPACK_IMPORTED_MODULE_4___default.a.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(_babel_runtime_corejs2_core_js_reflect_construct__WEBPACK_IMPORTED_MODULE_4___default()(Boolean, [], function () {})); return true; } catch (e) { return false; } }
...
var People = /*#__PURE__*/function (_React$Component) {
  ...
  function People(props) {
    ...
    if (_this.props.faculty) {
      _this.types = _this.types.slice(0, 1);
      _this.title = 'Faculty'; // this.types.splice(4, 2)
    }

    if (_this.props.students) {
      _this.types = _this.types.slice(2, 4);
      _this.title = 'Students';
      _this.short = true; // this.types.splice(4, 2)
    }

    var fileNames = _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_6___default()(_content_output_summary_json__WEBPACK_IMPORTED_MODULE_15__.fileMap);
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        var person = _babel_runtime_corejs2_core_js_object_assign__WEBPACK_IMPORTED_MODULE_5___default()(_content_output_summary_json__WEBPACK_IMPORTED_MODULE_15__.fileMap[key], {
          id: id
        });
    ...
    _this.people = lodash__WEBPACK_IMPORTED_MODULE_14___default.a.sortBy(_this.people, ['order']);
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_8__["default"])(People, [{
    ...
    value: function getPhotos() {
      var pictures = _content_output_files_json__WEBPACK_IMPORTED_MODULE_16__.children.filter(function (dir) {
    ...
    value: function render() {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement("div", {
      ...
      }), this.title), this.types.map(function (type) {
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement("div", {
          className: "people-category",
          key: type.title
        }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement("h2", null, ['faculty', 'postdoc'].includes(type.key) ? '' : type.title), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement("div", {
          className: "ui grid"
        ...
        .map(function (person) {
          ...
          var colNum = type.key === 'faculty' ? 'five' : 'four';
          return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement("a", {
            className: "".concat(colNum, " wide column person"),
            ...
            src: _this2.getPhoto(person)
          }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement("p", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement("b", null, person.name)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement("p", null, person.title, person.now && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement("span", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement("br", null), person.now)), type.key === 'faculty' && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement("div", {
            className: "ui large basic labels"
          }, person.keywords.map(function (keyword) {
            return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement("span", {
              className: "ui large inverted label label-brown-color"
            }, keyword);
          })) // <p>
      ...
      }), this.short && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement("div", {
...
//# sourceMappingURL=index.js.8fb62254f43a2dd079de.hot-update.js.map