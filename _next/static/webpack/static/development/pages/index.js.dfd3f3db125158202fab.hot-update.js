...
/***/ "./content/output/publications sync recursive ^\\.\\/.*$":
/*!***************************************************!*\
  !*** ./content/output/publications sync ^\.\/.*$ ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

var map = {
	"./iros-2020-hedayati": "./content/output/publications/iros-2020-hedayati.json",
	"./iros-2020-hedayati.json": "./content/output/publications/iros-2020-hedayati.json",
	"./uist-2020-suzuki": "./content/output/publications/uist-2020-suzuki.json",
...
webpackContext.id = "./content/output/publications sync recursive ^\\.\\/.*$";
...
var hoge = __webpack_require__(/*! ../content/output/publications/iros-2020-hedayati.json */ "./content/output/publications/iros-2020-hedayati.json");
...
try {
  for (_iterator.s(); !(_step = _iterator.n()).done;) {
    var key = _step.value;
    fuga = key;
    hoge = __webpack_require__("./content/output/publications sync recursive ^\\.\\/.*$")("./".concat(key.split('/'[3])));
    publications.push("../".concat(key));
  }
} catch (err) {
  _iterator.e(err);
} finally {
...
var Publications = /*#__PURE__*/function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_8__["default"])(Publications, [{
    ...
    value: function render() {
      console.log(__webpack_require__("./pages sync recursive")(fuga));
      console.log(hoge);
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_13___default.a.createElement("div", {
        id: "publications"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_13___default.a.createElement("h1", null, "Publications"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_13___default.a.createElement("p", null, _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_6___default()(publications)));
    }
  }]);
...
//# sourceMappingURL=index.js.dfd3f3db125158202fab.hot-update.js.map