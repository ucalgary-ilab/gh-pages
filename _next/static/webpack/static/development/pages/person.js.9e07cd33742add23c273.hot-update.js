  ...
  function Publications(props) {
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        _this.publications.push(_content_output_summary_json__WEBPACK_IMPORTED_MODULE_15__.fileMap[key]);
      }
    } catch (err) {
      _iterator.e(err);
    } finally {
    ...
    _this.publications = _this.publications.sort(function (a, b) {
    ...
    try {
      for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
        ...
        var person = _babel_runtime_corejs2_core_js_object_assign__WEBPACK_IMPORTED_MODULE_6___default()(_content_output_summary_json__WEBPACK_IMPORTED_MODULE_15__.fileMap[_key], {
          id: id
        });
    ...
    var _iterator3 = _createForOfIteratorHelper(_this.people),
        _step3;
...
//# sourceMappingURL=person.js.9e07cd33742add23c273.hot-update.js.map