...
var Meta = /*#__PURE__*/function (_React$Component) {
  ...
  function Meta(props) {
    ...
    if (!_this.props.title) {
      ...
      _this.title = "".concat(_this.props.title, " | ").concat(title);
    }

    if (!_this.props.description) {
      _this.description = 'Human-Computer Interaction and Information Visualization Group at the University of Calgary';
    } else {
      _this.description = _this.props.description;
    }

    if (!_this.props.keywords) {
      _this.keywords = 'Human-Computer Interaction, HCI, Information Visualization, University of Calgary, CHI, UIST';
    } else {
      _this.keywords = _this.props.keywords;
    }

    if (!_this.props.image) {
      _this.image = '/static/images/cover.jpg';
    } else {
      _this.image = _this.props.image;
    }

    if (!_this.props.url) {
      _this.url = 'https://ilab.ucalgary.ca/';
    } else {
      _this.url = _this.props.image;
    }
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Meta, [{
    ...
    value: function render() {
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(next_head__WEBPACK_IMPORTED_MODULE_7___default.a, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement("title", null, this.title), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement("meta", {
        name: "keywords",
...
//# sourceMappingURL=publication.js.e69a8cacf4637f0ba980.hot-update.js.map